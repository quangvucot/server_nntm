...
class DatasController {
  ...
  postSensorData(req, res) {
    ...
    const valueControl = {
      relay1: valuesSensor.relay1,
      relay2: valuesSensor.relay2,
      relay3: valuesSensor.relay3,
      relay4: valuesSensor.relay4,
      controlID: valuesSensor.controlID,
    };
    console.log("valuesSensor", valueControl);
    ...
    getRelay((err, results) => {
      ...
      if (valueControl.relay3 == undefined) {
        valueControl.relay3 = results.relay3;
      }
      if (valueControl.relay1 == undefined) {
        valueControl.relay1 = results.relay1;
      }
      if (valueControl.relay2 == undefined) {
        valueControl.relay2 = results.relay2;
      }
      if (valueControl.relay4 == undefined) {
        valueControl.relay4 = results.relay4;
      }
      updateRelay(valueControl, (err, results) => {
        if (err) {
          console.error(err);
          return;
        }
